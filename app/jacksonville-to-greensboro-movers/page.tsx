            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Greensboro starts here. We have decades of experience moving families and businesses to Greensboro and the Piedmont Triad. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "T&E Movers handled our move from Jacksonville to Greensboro flawlessly. The crew was punctual, professional, and worked incredibly hard. They took great care wrapping our furniture, and everything arrived without a single scratch. We were so impressed with their service."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We moved to Greensboro from Jacksonville for a change of pace. T&E Movers made it so easy. Their team was friendly, efficient, and very careful with our belongings. The upfront quote was accurate, which we really appreciated. A totally stress-free experience."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Michael and Jessica Lee</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Greensboro, NC</div>
                    <div className="text-xs text-gray-500">Young Couple's Move</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Downsizing from our home in Jacksonville to a smaller place in Greensboro felt like a huge project, but T&E Movers was a blessing. The crew was so patient and respectful. They handled our delicate items with such care, it put our minds completely at ease."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">George and Patricia Hill</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Greensboro, NC</div>
