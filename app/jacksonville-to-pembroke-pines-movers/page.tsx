            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Pembroke Pines starts here. We have decades of experience moving families and businesses to Pembroke Pines and the greater Fort Lauderdale area. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
              ...
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Family Move for Better Schools</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "My corporate relocation from Jacksonville to Pembroke Pines was handled by T&E Movers, and their service was impeccable. The team was punctual, the communication was clear, and my final bill was exactly what they quoted. It allowed me to focus on my new role without any moving stress."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Mark and Susan Brown</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Pembroke Pines, FL</div>
