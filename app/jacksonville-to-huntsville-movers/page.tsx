            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Huntsville starts here. We have decades of experience moving families and tech professionals to Huntsville, the Rocket City. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I moved from Jacksonville to Huntsville for an engineering role. I was most concerned about my sensitive lab equipment and computer hardware. The T&E team was meticulous with their packing and handling. Their attention to detail gave me complete peace of mind. A truly professional service."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Dr. Mark Evans</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Huntsville, AL</div>
                    <div className="text-xs text-gray-500">Engineering Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving our family of five to Huntsville was a huge undertaking, but T&E Movers was fantastic. The crew was friendly, hardworking, and great with our kids. They made sure every box and piece of furniture ended up in the right room, which was a massive help. We couldn't be happier."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We moved to Huntsville from Jacksonville after getting married. T&E Movers made our first big move together a wonderful experience. The team was so positive and efficient. They handled our new furniture with such care, and everything arrived perfectly. It was the best start to our new life together!"
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Laura and Ben Carter</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Huntsville, AL</div>
