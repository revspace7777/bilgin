            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Columbus starts here. We have decades of experience moving families and businesses to Columbus and all over Georgia. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "As a military family, we move a lot, and our experience with T&E Movers was one of the best. They were incredibly organized and efficient, and they took great care of all our belongings. They made our move from Jacksonville to Columbus completely seamless. We'll definitely be recommending them to other military families."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Military Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Jessica Brown</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Columbus, GA</div>
                    <div className="text-xs text-gray-500">Corporate Move</div>
                  </div>
                </div>
              </CardContent>
            </Card>
