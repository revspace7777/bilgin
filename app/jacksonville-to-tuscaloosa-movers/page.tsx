            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Tuscaloosa starts here. We have decades of experience moving families and students to Tuscaloosa and West Alabama. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Our move from Jacksonville to Tuscaloosa was handled with incredible professionalism by T&E Movers. The team was punctual, hardworking, and took great care with all of our belongings. They made what we thought would be a stressful day completely manageable. We're so thankful for their excellent service."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">The Miller Family</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Professor Davis</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Tuscaloosa, AL</div>
                    <div className="text-xs text-gray-500">University Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We moved from Jacksonville to Tuscaloosa to be closer to our son and his family. The T&E moving team was so kind and respectful. They handled our lifelong treasures with such care and patience. They truly went above and beyond to make our move a positive experience."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Robert and Susan Garcia</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Tuscaloosa, AL</div>
