    ...
    <div className="min-h-screen bg-white relative">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Local Moving Experts</p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-red-500 text-white px-4 py-2 text-sm font-medium opacity-0 animate-fade-in">
                  🏆 #1 Rated Local Moving Company in Jacksonville
                </Badge>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Professional Local Movers <span className="text-red-400">You Can Trust</span>
                </h1>
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your stress-free local move starts here. We've successfully completed thousands of local moves with a
                  99.8% customer satisfaction rate. Join hundreds of families who trusted us with their local moves.
                </p>
              </div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Local Moving Experts</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-12 bg-white border-b" data-accolades-section>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-60">
            ...
            <div className="text-center">
              <MapPin className="h-12 w-12 mx-auto mb-2 text-purple-500" />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why 5,000+ Families Choose T&E for Local Moves
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're not just another local moving company. We're your neighbors, your partners, and your peace of mind during
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">Local Expertise</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600">
                  Deep knowledge of Jacksonville and surrounding areas. We know the best routes, local regulations, and
                  how to navigate your community efficiently.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent className="text-center">
                <p className="text-gray-600">
                  Need to move quickly? We offer same-day local moving services because we understand that sometimes
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-6">The T&E Local Promise</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Transparent Pricing</h4>
                      <p className="text-gray-600">Your quote is your final price. No hidden fees, ever.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Local Care</h4>
                      <p className="text-gray-600">
                        Every item treated like a family heirloom, every customer like a neighbor.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Complete Local Moving Solutions
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              From apartments to houses, from residential to commercial - we handle all your local moving needs with the
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardTitle>Residential Moving</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Complete residential moving services for homes, apartments, and condos throughout Jacksonville.
                </p>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Professional business relocation services with minimal downtime for your company.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Professional packing and unpacking services with quality materials and careful handling.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardTitle>Loading & Unloading</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Careful handling and secure transportation of all your belongings with professional equipment.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Secure loading techniques</li>
                  <li>• Professional equipment</li>
                  <li>• Careful unloading process</li>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Secure storage facilities for short and long-term needs during your local move.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50" data-reviews-section>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Don't just take our word for it. Here's what our local moving customers have to say about their experience
              with T&E Movers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "T&E Moving made our local move so easy! They were professional, careful, and affordable. The team showed up on time and handled everything perfectly. Highly recommend!"
                </p>
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "The team was amazing - they handled everything from packing to setup. Our move was stress-free thanks to their attention to detail and professional service."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Fast, reliable, and professional. They moved our office in one day with minimal disruption to our business. Great local movers!"
                </p>
                <div className="flex items-center">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We've compiled answers to the most common questions about our local moving services. Can't find what you're
          ...
          <div className="max-w-4xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  We recommend booking at least 2-3 weeks in advance for local moves, especially during peak moving seasons (May-September). However, we can often accommodate last-minute moves when available.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Yes, we offer same-day moving services for local moves when available. Contact us for immediate availability and scheduling.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-5">
                <AccordionTrigger className="text-left">
                  What is included in your local moving quote?
                </AccordionTrigger>
                <AccordionContent>
                  Our quotes include loading, transportation, unloading, and basic furniture placement. Packing services are available for an additional fee. All quotes are transparent with no hidden costs.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent>
                  Yes, we are fully licensed and insured. Your belongings are protected throughout the entire moving process with comprehensive coverage for your peace of mind.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <section className="py-20 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">Ready to Start Your Local Move?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Get your free quote today and experience stress-free local moving with trusted professionals. 
            Join thousands of satisfied customers who chose T&E Movers for their local moves.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-sm">Experienced Movers</p>
            </div>
            <div className="text-center">
