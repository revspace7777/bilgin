...
export const metadata: Metadata = {
  title: 'Local Movers | T&E Moving',
  description: 'Professional local movers for homes, apartments, and offices. Get a free quote from T&E Moving.'
}
...
export default function LocalMoversPage() {
  return (
    <main>
      <HeroSection
        headline="Your Trusted Local Movers"
        subheadline="Stress-free, affordable, and reliable local moving services."
      ...
      <ValuePropositionSection
        title="Why Choose T&E for Your Local Move?"
        benefits={[
      ...
      />
      <FAQSection
        title="Local Movers FAQ"
        faqs={[
          { question: 'How much does a local move cost?', answer: 'It depends on distance, size, and services. Get a free quote!' },
