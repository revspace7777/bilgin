            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Montgomery starts here. We have decades of experience moving families and businesses to Montgomery and the surrounding River Region. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "After retiring from the Navy in Jacksonville, we moved to Montgomery. As a military family, we've moved many times, and T&E was by far the best. Their crew was disciplined, efficient, and showed great respect for our belongings. A flawless operation from start to finish."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Major Tom Davis (Ret.)</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Montgomery, AL</div>
                    <div className="text-xs text-gray-500">Military Retirement Move</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Our move from Jacksonville to Montgomery with T&E Movers was a fantastic experience. They were incredibly organized and handled all our items with care. The team worked hard and had a great attitude, which made the whole day so much better for our family. We highly recommend them!"
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I relocated for a government job in Montgomery, and T&E Movers made the transition from Jacksonville seamless. The quote was transparent, the movers were professional, and everything arrived exactly on schedule. It was a huge relief to have such a reliable team."
                </p>
                <div className="flex items-center">
