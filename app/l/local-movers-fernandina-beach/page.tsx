...
export default function FernandinaBeachMovers() {
  const checkZipCode = () => {
    ...
    const fernandinaBeachDMACodes = [32202, 32203, 32204, 32205, 32206, 32207, 32208, 32209, 32210, 32211, 32212, 32214, 32216, 32217, 32218, 32219, 32220, 32221, 32222, 32223, 32224, 32225, 32226, 32227, 32228, 32229, 32230, 32231, 32232, 32233, 32234, 32235, 32236, 32237, 32238, 32239, 32240, 32241, 32244, 32245, 32246, 32247, 32250, 32254, 32255, 32256, 32257, 32258, 32259, 32260, 32266, 32267, 32277];
    
    if (startingZip && destinationZip) {
      if (resultDiv) resultDiv.classList.remove('hidden');
      
      // Check if starting zip is in Fernandina Beach DMA
      if (fernandinaBeachDMACodes.includes(startingZip)) {
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Fernandina Beach Movers</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your trusted neighbors for seamless local moves throughout Fernandina Beach and surrounding areas. We've successfully completed over 15,000 local moves with a 99.8% customer satisfaction rate.
                </p>
              </div>
            ...
            <div className="relative">
              <Image
                ...
                alt="T&E Movers Fernandina Beach Fleet - Professional Moving Trucks"
                width={500}
                height={300}
