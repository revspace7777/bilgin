...
export default function JacksonvilleMovers() {
  const checkZipCode = () => {
    const startingZipInput = document.getElementById('startingZip') as HTMLInputElement;
    const destinationZipInput = document.getElementById('destinationZip') as HTMLInputElement;
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your trusted neighbors for seamless local moves throughout Jacksonville and surrounding areas. We've successfully completed over 15,000 local moves with a 99.8% customer satisfaction rate.
                </p>
              </div>
            ...
            <div className="relative">
              <Image
                ...
                alt="T&E Movers Jacksonville Fleet - Professional Moving Trucks"
                width={500}
                height={300}
