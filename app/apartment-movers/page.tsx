    ...
    <div className="min-h-screen bg-white relative">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Apartment Moving Experts</p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-red-500 text-white px-4 py-2 text-sm font-medium opacity-0 animate-fade-in">
                  🏆 #1 Rated Apartment Moving Company
                </Badge>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Expert <span className="text-red-400">Apartment Movers</span> You Can Trust
                </h1>
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your stress-free apartment move starts here. We've successfully completed thousands of apartment and condo moves with a
                  99.8% customer satisfaction rate. Join hundreds of renters who trusted us with their apartment moves.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-100">Apartment Moves</div>
                </div>
                <div className="text-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-semibold">Apartment Specialists</div>
      ...
      <section className="py-12 bg-white border-b" data-accolades-section>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-60">
            ...
            <div className="text-center">
              <Building2 className="h-12 w-12 mx-auto mb-2 text-purple-500" />
              <p className="text-sm font-medium">Apartment Experts</p>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why 2,000+ Renters Choose T&E for Apartment Moves
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're not just another moving company. We're apartment moving specialists who understand the unique challenges
              of apartment and condo moves. Here's what makes us different:
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">Apartment Specialists</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600">
                  We understand apartment layouts, elevator logistics, parking restrictions, and building requirements.
                  We've moved thousands of apartments successfully.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">Efficient Service</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600">
                  We work quickly and efficiently to minimize disruption to your neighbors and building staff.
                  Professional service that respects your building community.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent className="text-center">
                <p className="text-gray-600">
                  Need to move quickly? We offer same-day apartment moving services because we understand that
                  lease terms and apartment availability don't always align perfectly.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-6">The T&E Apartment Promise</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Building Compliance</h4>
                      <p className="text-gray-600">We follow all building rules and coordinate with management.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Neighbor-Friendly</h4>
                      <p className="text-gray-600">We work quietly and efficiently to minimize disruption.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600">
                        From packing to unpacking, we handle everything for your apartment move.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Complete Apartment Moving Services
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              From studio apartments to luxury condos - we handle all your apartment moving needs with the
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Efficient moving services for studio apartments and small spaces.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Compact furniture handling</li>
                  <li>• Space-efficient packing</li>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Comprehensive moving services for standard apartment sizes.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• Full-service packing</li>
                  <li>• Furniture disassembly</li>
                  <li>• Professional loading</li>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardTitle>Luxury Condos</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Premium moving services for luxury condos and high-end apartments.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• White glove service</li>
                  <li>• Luxury item handling</li>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Secure storage facilities for items you need to store during your apartment transition.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50" data-reviews-section>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Don't just take our word for it. Here's what our apartment moving customers have to say about their experience
              with T&E Movers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "T&E made my apartment move so easy! They handled everything professionally and worked efficiently in my building. Highly recommend for apartment moves!"
                </p>
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Moving from a 3rd floor apartment was a breeze with T&E. They coordinated with building management and had everything moved efficiently."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Professional apartment movers who understand building logistics. They made my condo move stress-free and efficient."
                </p>
                <div className="flex items-center">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We've compiled answers to the most common questions about our apartment moving services. Can't find what you're
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-left">
                  Do you coordinate with apartment building management?
                </AccordionTrigger>
                <AccordionContent>
                  Yes, we coordinate with building management to ensure compliance with all building rules, elevator reservations, and parking arrangements for your apartment move.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2">
                <AccordionTrigger className="text-left">
                  How do you handle elevator and parking logistics?
                </AccordionTrigger>
                <AccordionContent>
                  We coordinate elevator reservations and parking arrangements with building management. We work efficiently to minimize disruption to other residents.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3">
                <AccordionTrigger className="text-left">
                  What if my apartment has stairs or no elevator?
                </AccordionTrigger>
                <AccordionContent>
                  We're experienced with all types of apartment buildings, including walk-ups and buildings with stairs. Our team is trained to handle these situations safely and efficiently.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4">
                <AccordionTrigger className="text-left">
                  Do you provide packing materials for apartment moves?
                </AccordionTrigger>
                <AccordionContent>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  We recommend booking 2-3 weeks in advance for apartment moves, especially during peak moving seasons. However, we can often accommodate last-minute moves when available.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6">
                <AccordionTrigger className="text-left">
                  Are you licensed and insured for apartment moves?
                </AccordionTrigger>
                <AccordionContent>
                  Yes, we are fully licensed and insured. Your belongings are protected throughout the entire apartment moving process with comprehensive coverage for your peace of mind.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <section className="py-20 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">Ready to Start Your Apartment Move?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Get your free quote today and experience stress-free apartment moving with trusted professionals. 
            Join thousands of satisfied renters who chose T&E Movers for their apartment moves.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-sm">Apartment Experts</p>
            </div>
            <div className="text-center">
