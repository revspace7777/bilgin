...
export default function JacksonvilleToNorthCharlestonMovers() {

  const destinationCity = "North Charleston";
  const destinationState = "SC";

  // Schema Markup - Company info is static, route info is dynamic
  const schema = {
    "@context": "https://schema.org",
    "@type": "MovingCompany",
    "name": "T&E Moving and Storage LLC",
    "image": "https://tandemovers.com/images/logo-main.png",
    "@id": "https://tandemovers.com/",
    "url": "https://tandemovers.com/",
    "telephone": "+1-904-997-1884",
    "email": "t-emoving@hotmail.com",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "6556 Beach Boulevard",
    ...
    "sameAs": [
        "https://www.facebook.com/tandemoversflorida/",
        "https://www.instagram.com/tandemovers/"
    ],
    "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": `https://tandemovers.com/jacksonville-to-${destinationCity.toLowerCase()}-movers`
    },
    "areaServed": [
      { "@type": "City", "name": "Jacksonville" },
      { "@type": "AdministrativeArea", "name": "Duval County" },
      { "@type": "AdministrativeArea", "name": "St. Johns County" },
      { "@type": "City", "name": destinationCity }
    ],
    "makesOffer": {
        "@type": "Offer",
        "itemOffered": {
            "@type": "Service",
            "name": `Moving from Jacksonville to ${destinationCity}`,
            "serviceType": "Long-Distance Moving",
            "provider": {"@id": "https://tandemovers.com/"},
            "areaServed": [
              { "@type": "City", "name": "Jacksonville" },
              { "@type": "City", "name": destinationCity }
            ],
            "description": `Professional, reliable, and direct moving services for families and businesses relocating from Jacksonville, FL to ${destinationCity}, ${destinationState}.`,
            "isRelatedTo": [
                { "@type": "Service", "name": "Long-Distance Moving" },
                { "@type": "Service", "name": "Full-Service Packing" },
                { "@type": "Service", "name": "Secure Storage Solutions" },
                { "@type": "Service", "name": "Residential Moving" }
            ]
        }
    },
    "aggregateRating": {
...
{
            "@type": "Review",
            "author": { "@type": "Person", "name": "Jennifer and David Park" },
            "reviewRating": { "@type": "Rating", "ratingValue": "5" },
            "reviewBody": "Moving from Jacksonville to North Charleston for our new home was exciting, and T&E Movers made it even better. Their team was friendly, efficient, and handled everything with care. The price was exactly what they quoted, no hidden fees. Highly recommended!"
        },
{
            "@type": "Review",
            "author": { "@type": "Person", "name": "The Martinez Family" },
            "reviewRating": { "@type": "Rating", "ratingValue": "5" },
            "reviewBody": "We trusted T&E with our family's move from Jacksonville to North Charleston, and they delivered beyond our expectations. They were so careful with our children's toys and our family heirlooms. The crew was polite and made the whole experience smooth."
        },
{
            "@type": "Review",
            "author": { "@type": "Person", "name": "Patricia Williams" },
            "reviewRating": { "@type": "Rating", "ratingValue": "5" },
            "reviewBody": "I had an urgent job transfer from Jacksonville to North Charleston, and T&E Movers accommodated my timeline perfectly. They were incredibly efficient and had my entire apartment packed and moved in just two days. Their professionalism made a stressful situation manageable."
        }
]
  };
  ...
  return (<div className="min-h-screen bg-white relative">
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Image src="/images/logo-main.png" alt="T&E Moving and Storage LLC Logo" width={60} height={60} className="rounded-full" />
            <div>
              <h1 className="text-xl font-bold text-gray-900">T&E Movers</h1>
              <p className="text-sm text-gray-600">Your Jacksonville to North Charleston Moving Experts</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-red-500 text-white px-4 py-2 text-sm font-medium opacity-0 animate-fade-in">
                  🏆 #1 Rated Jacksonville to North Charleston Moving Company
                </Badge>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Moving from Jacksonville to North Charleston? <span className="text-red-400">T&E Movers</span> Gets You There With Ease.
                </h1>
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to North Charleston starts here. We have decades of experience moving families and businesses to North Charleston and the entire Charleston metro area. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
            ...
            <div className="relative">
              <Image
                ...
                alt="T&E Movers Fleet for Jacksonville to North Charleston moves"
                width={600}
                height={400}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're not just another moving company. We're your neighbors in Jacksonville, and we know the route to North Charleston like the back of our hand. Here's what makes us different:
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <Image
                  ...
                  alt="T&E Movers Jacksonville Facility - Aerial View"
                  width={500}
                  height={300}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="border-0 shadow-lg">
                  <CardHeader>
                    ...
                    <CardTitle>Jacksonville to North Charleston Moving</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 mb-4">
                      Direct service from anywhere in the Jacksonville area to your new home in North Charleston. No transfers, no delays.
                    </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  <span className="text-gray-600">Distance (Jacksonville to North Charleston)</span>
            ...
            <div className="space-y-8">
              {[
                ...
                },
                {
                  ...
                  description: "We create a custom moving timeline and coordinate all logistics for your Jacksonville to North Charleston move.",
                ...
                },
                {
                  ...
                  description: "Your items are loaded with care and transported directly to North Charleston in our modern trucks.",
                ...
                },
                {
                  ...
                  description: "We deliver on time and place everything exactly where you want it in your new North Charleston home.",
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50" data-reviews-section>
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12"><Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving from Jacksonville to North Charleston for our new home was exciting, and T&E Movers made it even better. Their team was friendly, efficient, and handled everything with care. The price was exactly what they quoted, no hidden fees. Highly recommended!"
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Jennifer and David Park</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → North Charleston, SC</div>
...
<Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We trusted T&E with our family's move from Jacksonville to North Charleston, and they delivered beyond our expectations. They were so careful with our children's toys and our family heirlooms. The crew was polite and made the whole experience smooth."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold mr-4">
                    MF
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">The Martinez Family</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → North Charleston, SC</div>
...
<Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I had an urgent job transfer from Jacksonville to North Charleston, and T&E Movers accommodated my timeline perfectly. They were incredibly efficient and had my entire apartment packed and moved in just two days. Their professionalism made a stressful situation manageable."
                </p>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold mr-4">
                    PW
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Get answers to common questions about moving from Jacksonville to North Charleston with T&E Movers.
            </p>
          </div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  How long does it take to move from Jacksonville to North Charleston?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
                  The drive from Jacksonville to North Charleston is approximately 4-5 hours. For a typical household move, we can complete loading, transport, and unloading within 1-2 days, depending on the size of your home and specific requirements. We'll provide an exact timeline during your free estimate.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2" className="border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  How much does it cost to move from Jacksonville to North Charleston?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
              ...
              <AccordionItem value="item-3" className="border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  Do you provide packing services for North Charleston moves?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
              ...
              <AccordionItem value="item-4" className="border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  Are you licensed and insured for moves to North Charleston?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
              ...
              <AccordionItem value="item-5" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  Yes, we offer vehicle transport services for cars, motorcycles, boats, and other vehicles. We work with trusted auto transport partners to provide both open and enclosed vehicle shipping. This can be coordinated to arrive at your new North Charleston home around the same time as your household goods.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6" className="border border-gray-200 rounded-lg px-6">
                <AccordionTrigger className="text-left">
                  What if I need storage during my move to North Charleston?
                </AccordionTrigger>
                <AccordionContent className="text-gray-600 pb-4">
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Jacksonville to North Charleston Moving Checklist
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Stay organized with our comprehensive moving checklist designed specifically for Jacksonville to North Charleston relocations.
            </p>
          </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        ...
                        <span className="text-gray-700">Research North Charleston neighborhoods and schools</span>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Research North Charleston job market if needed</span>
                      </div>
                    </div>
                  </Card>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Book hotel if overnight stay needed in North Charleston</span>
                      </div>
                    </div>
                  </Card>
                  <Card className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Set up utilities at your new North Charleston home</span>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                      ...
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Find new healthcare providers in North Charleston</span>
                      </div>
                    </div>
                  </Card>
                  <Card className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Pack a suitcase with essentials for North Charleston</span>
                      </div>
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                  ...
                  <Card className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Check inventory upon delivery in North Charleston</span>
                      </div>
                    </div>
                  </Card>
                </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div>
              <div className="flex items-center space-x-3 mb-6">
                <Image src="/images/logo-main.png" alt="T&E Moving and Storage LLC White Logo" width={50} height={50} className="rounded-full" />
                <div>
                  <h3 className="text-2xl font-bold">T&E Moving and Storage LLC</h3>
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/tandemoversflorida/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                    f
                </a>
                <a href="https://www.instagram.com/tandemovers/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-pink-600 rounded-full flex items-center justify-center text-white">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors">Jacksonville to North Charleston Moving</li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="hover:text-white transition-colors">Jacksonville to North Charleston Moves</li>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-400">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-white">
                        <a href="mailto:t-emoving@hotmail.com" className="text-white">t-emoving@hotmail.com</a>
                    </div>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="text-gray-400">
                <p>&copy; {new Date().getFullYear()} T&E Moving and Storage LLC. All rights reserved.</p>
