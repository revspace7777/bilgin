            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Savannah starts here. We have decades of experience moving families and businesses to Savannah and all over Georgia. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I had to move from Jacksonville to Savannah for work, and T&E Movers made the process completely stress-free. They provided an accurate quote, showed up on time, and had my entire apartment moved in just a few hours. The crew was friendly and professional, and I couldn't be happier with the service."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We were so excited to move into our first home in Savannah, and T&E Movers made the experience even better. They were so careful with all of our belongings and made sure everything was set up exactly how we wanted it. They really went above and beyond to make our move special. We highly recommend them!"
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Sarah and Ben Carter</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Savannah, GA</div>
                    <div className="text-xs text-gray-500">First Home Purchase</div>
                  </div>
                </div>
              </CardContent>
            </Card>
