            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Augusta starts here. We have decades of experience moving families and businesses to Augusta and all over Georgia. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Our move from Jacksonville to Augusta was a breeze thanks to T&E Movers. The crew was professional, friendly, and incredibly efficient. They took great care of our furniture and made sure everything was placed exactly where we wanted it in our new home. A fantastic experience from start to finish."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I was moving from Jacksonville to Augusta for a university program and was stressed about doing it alone. The T&E team was amazing. They were so helpful and made the whole process feel easy. My belongings arrived in perfect condition, and they even helped me set up my bed. I'm so grateful for their help."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Emily White</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Augusta, GA</div>
                    <div className="text-xs text-gray-500">University Transfer</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We were downsizing from our large home in Jacksonville to a smaller house in Augusta, and T&E Movers was the perfect choice. They were incredibly patient as we decided what to take and what to leave, and they handled all of our fragile items with the utmost care. We couldn't have done it without them."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Mark and Susan Peterson</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Augusta, GA</div>
