            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Tallahassee starts here. We have decades of experience moving families, students, and professionals to Tallahassee and the Panhandle. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "My husband's new job with the state required a quick move from Jacksonville to Tallahassee. T&E Movers was incredibly professional and worked around our tight schedule. Their crew handled our sensitive documents and home office equipment with extra care, which made the transition seamless. We were so relieved to be settled in so quickly."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Karen and Sam Brighton</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Tallahassee, FL</div>
                    <div className="text-xs text-gray-500">State Government Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We moved from Jacksonville to Tallahassee for the great schools, and T&E made the process so easy for our family. They were patient with our two kids and even helped assemble their beds first thing upon arrival. It made a potentially stressful day so much more manageable. A truly family-friendly moving company!"
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Jacksonville, FL → Tallahassee, FL</div>
                    <div className="text-xs text-gray-500">Family Move for Schools</div>
                  </div>
                </div>
              </CardContent>
            </Card>
