            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Davie starts here. We have decades of experience moving families and businesses to Davie and throughout Broward County. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving our family and our two horses from Jacksonville to Davie was a complex job. T&E Movers handled our household goods with perfection, and their recommended vehicle transporter was equally professional. They made a complicated move feel simple and straightforward. We're so grateful."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I relocated from Jacksonville for a new position at the university in Davie. The T&E crew was incredibly efficient and professional. They handled my extensive library of books and research materials with great care. It was a relief to have everything arrive safely and ready for me to set up my new office."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Jacksonville, FL → Davie, FL</div>
                    <div className="text-xs text-gray-500">University Staff Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">David and Linda Rodriguez</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Davie, FL</div>
