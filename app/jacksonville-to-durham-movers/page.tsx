...
export default function JacksonvilleToDurhamMovers() {
  return (
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Your Jacksonville to Durham Moving Experts</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-red-500 text-white px-4 py-2 text-sm font-medium opacity-0 animate-fade-in">
                  🏆 #1 Rated Jacksonville to Durham Moving Company
                </Badge>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Moving from Jacksonville to Durham? <span className="text-red-400">T&E Movers</span> Gets You There With Ease.
                </h1>
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Durham starts here. We have decades of experience moving families and professionals to Durham and the Research Triangle. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
            ...
            <div className="relative">
              <Image
                ...
                alt="T&E Movers Fleet for Jacksonville to Durham moves"
                width={600}
                height={400}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're not just another moving company. We're your neighbors in Jacksonville, and we know the route to Durham like the back of our hand. Here's what makes us different:
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <Card className="border-0 shadow-lg">
                  <CardHeader>
                    ...
                    <CardTitle>Jacksonville to Durham Moving</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 mb-4">
                      Direct service from anywhere in the Jacksonville area to your new home in Durham. No transfers, no delays.
                    </p>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We both took positions at Duke and moved from Jacksonville. T&E Movers was outstanding. They understood our hectic schedules and handled the logistics perfectly. Our extensive library and home offices were packed and moved with exceptional care. We felt we were in expert hands."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Dr. Evans and Dr. Martinez</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Durham, NC</div>
                    <div className="text-xs text-gray-500">Medical Professionals Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving our family to Durham was a big step, and T&E Movers made it a wonderful experience. The crew was efficient and so friendly to our kids. They made sure all our furniture was set up perfectly in our new home, which helped us feel settled right away."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">The Turner Family</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Durham, NC</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I moved my small startup's office and my apartment from Jacksonville to Durham. T&E handled both with incredible professionalism. They were careful with my expensive tech equipment and made the entire process efficient and straightforward. Highly recommended for any move, big or small."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Ben Carter</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Durham, NC</div>
                    <div className="text-xs text-gray-500">Tech Startup Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="hover:text-white transition-colors">Jacksonville to Durham Moving</li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                ...
                <li className="hover:text-white transition-colors">Jacksonville to Durham Moves</li>
