            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Macon starts here. We have decades of experience moving families and businesses to Macon and throughout Central Georgia. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "T&E Movers provided a fantastic service for our move from Jacksonville to Macon. The team was professional, efficient, and handled our belongings with extreme care. Moving with two young kids is tough, but they made the process smooth and stress-free. We were so relieved and happy with the result."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I relocated to Macon for a professorship at Mercer University. T&E Movers was outstanding. They meticulously packed my large collection of books and research materials. Their professionalism and punctuality made my transition from Jacksonville completely seamless. A top-tier service."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Dr. Allen</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Macon, GA</div>
                    <div className="text-xs text-gray-500">University Professor Relocation</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We chose to retire in Macon to be closer to nature, and T&E handled our move from Jacksonville. The crew was exceptionally respectful and careful with our antique furniture. Their positive attitude and hard work made our move a genuinely pleasant experience. We highly recommend them."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Carol and Jim Henderson</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Macon, GA</div>
