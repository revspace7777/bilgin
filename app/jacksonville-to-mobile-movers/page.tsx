            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Mobile starts here. We have decades of experience moving families and businesses to Mobile, AL and the Gulf Coast. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "T&E Movers did an outstanding job with our move from Jacksonville to Mobile. The crew was professional, efficient, and handled our belongings with great care. Moving can be stressful, but they made the entire process smooth and worry-free. We were so impressed with their service."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I relocated to Mobile for a job in the shipping industry. The team at T&E Movers was fantastic. They provided a clear, upfront quote, and the crew was incredibly professional and hardworking. They made a potentially complex move from Jacksonville feel simple. Highly recommend."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Brian Scott</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Mobile, AL</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We retired to Mobile from Jacksonville, and T&E Movers was the perfect choice for our move. The crew was so courteous and took special care of our antique furniture and fragile items. Their respectful and professional approach made our transition into retirement a very pleasant one."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">George and Helen Wright</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Mobile, AL</div>
