    ...
    <div className="min-h-screen bg-white relative">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">House Moving Experts</p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-red-500 text-white px-4 py-2 text-sm font-medium opacity-0 animate-fade-in">
                  🏆 #1 Rated House Moving Company
                </Badge>
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  Professional <span className="text-red-400">House Movers</span> You Can Trust
                </h1>
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your home is your biggest investment - trust it to experienced house moving professionals. We've successfully moved thousands of homes with care, precision, and the attention to detail your house deserves.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-red-400">5K+</div>
                  <div className="text-sm text-blue-100">Houses Moved</div>
                </div>
                <div className="text-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-lg shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-semibold">House Specialists</div>
      ...
      <section className="py-12 bg-white border-b" data-accolades-section>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-60">
            ...
            <div className="text-center">
              <House className="h-12 w-12 mx-auto mb-2 text-purple-500" />
              <p className="text-sm font-medium">House Experts</p>
            </div>
            <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why 5,000+ Homeowners Choose T&E for House Moves
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We're not just another moving company. We're house moving specialists who understand that your home contains your life's memories and investments. Here's what makes us different:
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">House Specialists</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600">
                  We understand the unique challenges of house moves - from large furniture to delicate items, we handle everything with the care your home deserves.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent className="text-center">
                <p className="text-gray-600">
                  From packing to unpacking, furniture assembly to appliance installation - we handle every aspect of your house move.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-center">Efficient Process</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <p className="text-gray-600">
                  Our experienced teams work quickly and efficiently to minimize disruption to your life while ensuring nothing is damaged or lost.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-6">The T&E House Moving Promise</h3>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      <h4 className="font-semibold text-gray-900">Complete Protection</h4>
                      <p className="text-gray-600">Comprehensive insurance coverage for your entire home and belongings.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600">Trained professionals who treat your home and belongings with respect.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <p className="text-gray-600">
                        From initial consultation to final setup, we handle every detail of your house move.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Complete House Moving Services
            </h2>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              From small homes to large estates - we handle all your house moving needs with the same level of care and professionalism.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg">
              <CardHeader>
                <House className="h-12 w-12 text-blue-500 mb-4" />
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardTitle>Large Homes & Estates</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Specialized services for large homes and luxury estates.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• White glove service</li>
                  <li>• Luxury item handling</li>
                  <li>• Multiple truck coordination</li>
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent>
                <p className="text-gray-600 mb-4">
                  Secure storage facilities for items you need to store during your house transition.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-blue-50" data-reviews-section>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Don't just take our word for it. Here's what our house moving customers have to say about their experience
              with T&E Movers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "T&E moved our entire house with such care and professionalism. Everything arrived in perfect condition and they set up our new home beautifully!"
                </p>
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Moving a 4-bedroom house was a breeze with T&E. They handled everything from packing to furniture assembly. Highly recommend!"
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-lg bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-gray-700 mb-4 italic">
                  "Professional house movers who understand the value of our home and belongings. They made our move stress-free and efficient."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Karen L.</div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              We've compiled answers to the most common questions about our house moving services. Can't find what you're
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-left">
                  How do you handle large furniture and appliances?
                </AccordionTrigger>
                <AccordionContent>
                  We have specialized equipment and techniques for moving large furniture and appliances. Our team is trained to safely disassemble, move, and reassemble items like pianos, pool tables, and heavy appliances.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2">
                <AccordionTrigger className="text-left">
                  Do you provide packing materials for house moves?
                </AccordionTrigger>
                <AccordionContent>
                  Yes, we provide all necessary packing materials including boxes, tape, bubble wrap, furniture blankets, and specialty containers for fragile items and valuable possessions.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3">
                <AccordionTrigger className="text-left">
                  How far in advance should I book my house move?
                </AccordionTrigger>
                <AccordionContent>
                  We recommend booking 3-4 weeks in advance for house moves, especially during peak moving seasons. This ensures we can provide the complete service your home deserves.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Yes, we have specialized training and equipment for moving pianos, artwork, antiques, and other valuable items. We treat these items with extra care and attention.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent>
                  We offer secure, climate-controlled storage facilities for items you need to store during your house transition. We can coordinate moving and storage services for your convenience.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6">
                <AccordionTrigger className="text-left">
                  Are you licensed and insured for house moves?
                </AccordionTrigger>
                <AccordionContent>
                  Yes, we are fully licensed and insured. Your home and belongings are protected throughout the entire house moving process with comprehensive coverage for your peace of mind.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
      ...
      <section className="py-20 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">Ready to Move Your House?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Get your free quote today and experience professional house moving with trusted experts. 
            Join thousands of satisfied homeowners who chose T&E Movers for their house moves.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-sm">House Experts</p>
            </div>
            <div className="text-center">
