            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Birmingham starts here. We have decades of experience moving families and businesses to Birmingham and all over Alabama. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "My company transferred us from Jacksonville to Birmingham, and T&E Movers handled everything. Their team was professional, the communication was excellent, and the move was completed without a hitch. It made a huge corporate move feel incredibly simple and stress-free."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Relocating for a residency at UAB Hospital was a big step. The T&E crew was fantastic, carefully handling all my books and delicate medical equipment. They made the move from Jacksonville to Birmingham completely seamless so I could focus on starting my new position."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "We moved from Jacksonville to Birmingham to be closer to our grandchildren. The movers were so courteous and respectful of our belongings, especially the sentimental items. They worked efficiently and made us feel comfortable throughout the day. We are so grateful for their wonderful service."
                </p>
                <div className="flex items-center">
