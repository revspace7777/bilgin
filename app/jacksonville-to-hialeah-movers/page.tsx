            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Hialeah starts here. We have decades of experience moving families and businesses to Hialeah and the greater Miami area. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving from Jacksonville to Hialeah to be closer to family was a big decision. T&E Movers was fantastic. Their crew was bilingual, which was a great help, and they handled all our belongings with care. It made the entire process feel welcoming and stress-free."
                </p>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "My company transferred me to a new warehouse in Hialeah. T&E coordinated the entire move from my apartment in Jacksonville. They were punctual, professional, and the final bill matched the quote exactly. It was a seamless experience from start to finish."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Marcus Thorne</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Hialeah, FL</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I was moving from Jacksonville to a lovely retirement community in Hialeah. The young men from T&E were so respectful and gentle with my fragile glass collection that I've had for years. They took their time and made sure everything was perfect. I couldn't be more thankful for their kindness."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Eleanor Vance</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Hialeah, FL</div>
