            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Fort Lauderdale starts here. We have decades of experience moving families and businesses to Fort Lauderdale and all of Broward County. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">~350 miles</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Mark and Jenna Riley</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Fort Lauderdale, FL</div>
                    <div className="text-xs text-gray-500">Young Professional Couple</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">The Campbell Family</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Fort Lauderdale, FL</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Robert and Susan Peterson</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Fort Lauderdale, FL</div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  The drive from Jacksonville to Fort Lauderdale is approximately 5-6 hours. For a typical household move, we can complete loading, transport, and unloading within 1-2 days, depending on the size of your home and specific requirements. We'll provide an exact timeline during your free estimate.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  Moving costs vary based on the size of your home, services needed, and timing. A typical 2-3 bedroom home ranges from $2,800-$5,200 for full-service moving. We provide free, no-obligation estimates that include all costs upfront with our price-lock guarantee.
                </AccordionContent>
              </AccordionItem>
