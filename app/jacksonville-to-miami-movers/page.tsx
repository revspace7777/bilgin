            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Miami starts here. We have decades of experience moving families and businesses to Miami and all over South Florida. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">~345 miles</span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving our family from Jacksonville to be closer to relatives in Miami was a big step. T&E Movers handled everything with incredible care, especially our children's furniture. The crew was professional, courteous, and made us feel at ease. We were so relieved when everything arrived perfectly."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Carlos & Sofia Garcia</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I accepted a new job in Miami and needed to move quickly from Jacksonville. T&E's team was a lifesaver. They were efficient, communicative, and my price was exactly what they quoted. They made a stressful corporate relocation feel simple and straightforward. A truly professional team."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Megan Riley</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Miami, FL</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "I was downsizing from my house in Jacksonville to a condo in Miami Beach. My biggest concern was my art collection. The crew from T&E was meticulous, providing custom crating and handling each piece with the utmost respect. They navigated the condo elevator and tight corners flawlessly. I couldn't be more impressed."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Arthur Vance</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Miami, FL</div>
            ...
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="item-1" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  The drive from Jacksonville to Miami is approximately 5-6 hours. For a typical household move, we can complete loading, transport, and unloading within 1-2 days, depending on the size of your home and specific requirements. We'll provide an exact timeline during your free estimate.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  Moving costs vary based on the size of your home, services needed, and timing. A typical 2-3 bedroom home ranges from $2,500-$4,500 for full-service moving. We provide free, no-obligation estimates that include all costs upfront with our price-lock guarantee.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-6" className="border border-gray-200 rounded-lg px-6">
                ...
                <AccordionContent className="text-gray-600 pb-4">
                  We offer both short-term and long-term storage solutions in climate-controlled facilities. Whether you need storage because your new home isn't ready or you're downsizing, we can store your belongings safely and deliver them when you're ready. Storage is available in both Jacksonville and Miami areas.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
