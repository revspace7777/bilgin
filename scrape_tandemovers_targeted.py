#!/usr/bin/env python3
"""
Targeted Tandemovers.com Website Scraper
Extracts main content from specific known pages and saves as markdown files
"""
...
class TandemoversTargetedScraper:
    def __init__(self):
    ...
    def extract_images(self, soup, page_url):
        ...
        for img in img_tags:
            ...
            if src:
                ...
                if any(skip in src.lower() for skip in ['facebook', 'google', 'analytics', 'tracking', 'pixel']):
                    continue
...
if __name__ == "__main__":
    scraper = TandemoversTargetedScraper()
