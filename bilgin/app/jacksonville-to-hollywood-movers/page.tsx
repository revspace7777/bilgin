            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100 leading-relaxed">
                  Your seamless move from Jacksonville to Hollywood starts here. We have decades of experience moving families and businesses to Hollywood, FL and the surrounding coastal communities. Join thousands of families who trusted us with their most important possessions.
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Moving to Hollywood from Jacksonville was our first big move together, and T&E made it a fantastic experience. The crew was friendly, fast, and took great care of our new furniture. Their transparent pricing was a huge plus for us. We felt like we were in great hands the entire time."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Emily and Tom Carter</div>
                    <div className="text-sm text-gray-600">Jacksonville, FL → Hollywood, FL</div>
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "Our family's move to Hollywood, FL, was handled perfectly by T&E Movers. They were professional from the first call to the final box. The crew worked tirelessly and made sure all our belongings, especially the kids' bikes and toys, were moved without a scratch. Highly recommend their services."
                </p>
                <div className="flex items-center">
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8">
                ...
                <Quote className="h-8 w-8 text-gray-300 mb-4" />
                <p className="text-gray-700 mb-6 leading-relaxed">
                  "My company coordinated my move from Jacksonville to Hollywood with T&E. The entire process was seamless. The movers were punctual, incredibly efficient, and handled my home office setup with expertise. It was the smoothest corporate move I've ever experienced."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Jacksonville, FL → Hollywood, FL</div>
                    <div className="text-xs text-gray-500">Corporate Transfer</div>
                  </div>
                </div>
              </CardContent>
            </Card>
